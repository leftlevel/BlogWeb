<template>
    <div class="comment" :id="`comment${comment.id}`">
                ...
                <section-title>
                    <div style="display: flex;align-items: center;justify-content: space-between;">
                        ...
                        <div style="font-size: 13px;">
                            <span style="color: #9c9c9c;margin-right: 20px;">{{comment.commentTime}}</span>
                            <span @click.stop="reply(comment.fromUserName)" style="cursor: pointer;">回复</span>
                        </div>
                    </div>
                </section-title>
            </div>
        ...
        <div class="comment-body">
            <div class="content-text" v-html="comment.content"></div>
